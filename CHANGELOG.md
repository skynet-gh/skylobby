...
## [0.7.53](https://github.com/skynet-gh/skylobby/releases/tag/0.7.53)
...
## [0.7.49](https://github.com/skynet-gh/skylobby/releases/tag/0.7.49)
...
## [0.7.48](https://github.com/skynet-gh/skylobby/releases/tag/0.7.48)

- Fix spring root picker showing when cli arg is set

## [0.7.47](https://github.com/skynet-gh/skylobby/releases/tag/0.7.47)

- Add setting to show hidden modoptions, default off

## [0.7.46](https://github.com/skynet-gh/skylobby/releases/tag/0.7.46)

- Fix battle status parsing for id and ally

## [0.7.45](https://github.com/skynet-gh/skylobby/releases/tag/0.7.45)
...
## [0.7.44](https://github.com/skynet-gh/skylobby/releases/tag/0.7.44)
...
## [0.7.43](https://github.com/skynet-gh/skylobby/releases/tag/0.7.43)

- Fix some sent messages not recorded to correct server
- Clean up spectate change code

## [0.7.42](https://github.com/skynet-gh/skylobby/releases/tag/0.7.42)

- Fix bool modoptions in start script

## [0.7.41](https://github.com/skynet-gh/skylobby/releases/tag/0.7.41)
...
## [0.7.40](https://github.com/skynet-gh/skylobby/releases/tag/0.7.40)
...
## [0.7.39](https://github.com/skynet-gh/skylobby/releases/tag/0.7.39)
...
## [0.7.38](https://github.com/skynet-gh/skylobby/releases/tag/0.7.38)
...
## [0.7.37](https://github.com/skynet-gh/skylobby/releases/tag/0.7.37)
...
## [0.7.36](https://github.com/skynet-gh/skylobby/releases/tag/0.7.36)

- Add setting to view windows as tabs
- Fix an issue with downloading rapid latest versions
- Rename Welcome tab to Main

## [0.7.32](https://github.com/skynet-gh/skylobby/releases/tag/0.7.32), [0.7.33](https://github.com/skynet-gh/skylobby/releases/tag/0.7.33), [0.7.34](https://github.com/skynet-gh/skylobby/releases/tag/0.7.34), and [0.7.35](https://github.com/skynet-gh/skylobby/releases/tag/0.7.35)
...
## [0.7.31](https://github.com/skynet-gh/skylobby/releases/tag/0.7.31)

- Add tab to help users pick Spring directory

## [0.7.29](https://github.com/skynet-gh/skylobby/releases/tag/0.7.29) and [0.7.30](https://github.com/skynet-gh/skylobby/releases/tag/0.7.30)

- Fix mac release and native actions
- Fix releases action

## [0.7.28](https://github.com/skynet-gh/skylobby/releases/tag/0.7.28)
...
## [0.7.27](https://github.com/skynet-gh/skylobby/releases/tag/0.7.27)

- Fix sync status not updated when battle map changes
- Fix http server backend type for web ui

## [0.7.26](https://github.com/skynet-gh/skylobby/releases/tag/0.7.26)
...
## [0.7.21](https://github.com/skynet-gh/skylobby/releases/tag/0.7.21)

- Add password reset button
- Fix replay downloads from main table
- Add support for replays in .sdf format

## [0.7.20](https://github.com/skynet-gh/skylobby/releases/tag/0.7.20)
...
## [0.7.19](https://github.com/skynet-gh/skylobby/releases/tag/0.7.19)
...
## [0.7.18](https://github.com/skynet-gh/skylobby/releases/tag/0.7.18)
...
## [0.7.17](https://github.com/skynet-gh/skylobby/releases/tag/0.7.17)
...
## [0.7.16](https://github.com/skynet-gh/skylobby/releases/tag/0.7.16)
...
## [0.7.15](https://github.com/skynet-gh/skylobby/releases/tag/0.7.15)
...
## [0.7.14](https://github.com/skynet-gh/skylobby/releases/tag/0.7.14)

- Add engine select when multiple for a version
- Fix state churn issue from tasks

## [0.7.13](https://github.com/skynet-gh/skylobby/releases/tag/0.7.13)
...
## [0.7.12](https://github.com/skynet-gh/skylobby/releases/tag/0.7.12)
...
## [0.7.11](https://github.com/skynet-gh/skylobby/releases/tag/0.7.11)
...
## [0.7.10](https://github.com/skynet-gh/skylobby/releases/tag/0.7.10)

- Rework auto resources for rapid
- Delete sdp files if they are invalid
- Update BAR server url

## [0.7.9](https://github.com/skynet-gh/skylobby/releases/tag/0.7.9)

- Fix engine download source button
- Add engine source update to auto resources

## [0.7.8](https://github.com/skynet-gh/skylobby/releases/tag/0.7.8)
...
## [0.7.7](https://github.com/skynet-gh/skylobby/releases/tag/0.7.7)

- Fix color picker
- Attempt to fix issues with auto get resources
- Start work on lightweight web UI

## [0.7.6](https://github.com/skynet-gh/skylobby/releases/tag/0.7.6)
...
## [0.7.5](https://github.com/skynet-gh/skylobby/releases/tag/0.7.5)

- Fix an issue when windows are minimzed then reopened

## [0.7.4](https://github.com/skynet-gh/skylobby/releases/tag/0.7.4)

- Move singleplayer battle to a tab

## [0.7.3](https://github.com/skynet-gh/skylobby/releases/tag/0.7.3)
...
## [0.7.2](https://github.com/skynet-gh/skylobby/releases/tag/0.7.2)
...
## [0.7.1](https://github.com/skynet-gh/skylobby/releases/tag/0.7.1)
...
## [0.7.0](https://github.com/skynet-gh/skylobby/releases/tag/0.7.0)

- Get auto update working on Windows

## [0.6.20](https://github.com/skynet-gh/skylobby/releases/tag/0.6.20)
...
## [0.6.19](https://github.com/skynet-gh/skylobby/releases/tag/0.6.19)
...
## [0.6.18](https://github.com/skynet-gh/skylobby/releases/tag/0.6.18)
...
## [0.6.17](https://github.com/skynet-gh/skylobby/releases/tag/0.6.17)
...
## [0.6.16](https://github.com/skynet-gh/skylobby/releases/tag/0.6.16)
...
## [0.6.15](https://github.com/skynet-gh/skylobby/releases/tag/0.6.15)
...
## [0.6.14](https://github.com/skynet-gh/skylobby/releases/tag/0.6.14)
...
## [0.6.13](https://github.com/skynet-gh/skylobby/releases/tag/0.6.13)
...
## [0.6.12](https://github.com/skynet-gh/skylobby/releases/tag/0.6.12)
...
## [0.6.11](https://github.com/skynet-gh/skylobby/releases/tag/0.6.11)

- Fix NPE in chat and console tabs

## [0.6.10](https://github.com/skynet-gh/skylobby/releases/tag/0.6.10)

- Fix singleplayer game not starting when spec
- Fix minimap image not showing after download

## [0.6.9](https://github.com/skynet-gh/skylobby/releases/tag/0.6.9)

- Fix server tab highlight on muted battle

## [0.6.8](https://github.com/skynet-gh/skylobby/releases/tag/0.6.8)
...
## [0.6.7](https://github.com/skynet-gh/skylobby/releases/tag/0.6.7)

- Fix chat focus tracking

## [0.6.6](https://github.com/skynet-gh/skylobby/releases/tag/0.6.6)
...
## [0.6.5](https://github.com/skynet-gh/skylobby/releases/tag/0.6.5)

- Add tab highlighting on new chats

## [0.6.4](https://github.com/skynet-gh/skylobby/releases/tag/0.6.4)
...
## [0.6.3](https://github.com/skynet-gh/skylobby/releases/tag/0.6.3)
...
## [0.6.2](https://github.com/skynet-gh/skylobby/releases/tag/0.6.2)
...
## [0.6.1](https://github.com/skynet-gh/skylobby/releases/tag/0.6.1)
...
## [0.6.0](https://github.com/skynet-gh/skylobby/releases/tag/0.6.0)

- Switch UI to use context for better performance

## [0.5.9](https://github.com/skynet-gh/skylobby/releases/tag/0.5.9)

- Fix issue with config validation

## [0.5.8](https://github.com/skynet-gh/skylobby/releases/tag/0.5.8)
...
## [0.5.7](https://github.com/skynet-gh/skylobby/releases/tag/0.5.7)
...
## [0.5.6](https://github.com/skynet-gh/skylobby/releases/tag/0.5.6)
...
## [0.5.5](https://github.com/skynet-gh/skylobby/releases/tag/0.5.5)
...
## [0.5.4](https://github.com/skynet-gh/skylobby/releases/tag/0.5.4)
...
## [0.5.3](https://github.com/skynet-gh/skylobby/releases/tag/0.5.3)

- Add setting to show battle below battles again
- Attempt to fix dropdown position issue
- Workaround for SSL login issue

## [0.5.2](https://github.com/skynet-gh/skylobby/releases/tag/0.5.2)

- Save window maximized states
- Reduce frequency of window state sync

## [0.5.1](https://github.com/skynet-gh/skylobby/releases/tag/0.5.1)

- Fix unable to stop auto unspec

## [0.5.0](https://github.com/skynet-gh/skylobby/releases/tag/0.5.0)
...
## [0.4.18](https://github.com/skynet-gh/skylobby/releases/tag/0.4.18)

- Fix client id not set

## [0.4.17](https://github.com/skynet-gh/skylobby/releases/tag/0.4.17)
...
## [0.4.16](https://github.com/skynet-gh/skylobby/releases/tag/0.4.16)
...
## [0.4.15](https://github.com/skynet-gh/skylobby/releases/tag/0.4.15)

- Improve chat auto scroll
- Improve performance of chat and console rendering

## [0.4.14](https://github.com/skynet-gh/skylobby/releases/tag/0.4.14)
...
## [0.4.13](https://github.com/skynet-gh/skylobby/releases/tag/0.4.13)

- Add autounspec when teamsize is changed

## [0.4.12](https://github.com/skynet-gh/skylobby/releases/tag/0.4.12)
...
## [0.4.11](https://github.com/skynet-gh/skylobby/releases/tag/0.4.11)

- Fix infinite loop in map and mod refresh when errors reading
- Fix auto unspec when a player leaves a battle

## [0.4.10](https://github.com/skynet-gh/skylobby/releases/tag/0.4.10)
...
## [0.4.9](https://github.com/skynet-gh/skylobby/releases/tag/0.4.9)
...
## [0.4.8](https://github.com/skynet-gh/skylobby/releases/tag/0.4.8)

- Add ignore user to context menu
- Add join and leave to chat

## [0.4.7](https://github.com/skynet-gh/skylobby/releases/tag/0.4.7)

- Update springfiles url to springfiles.springrts.com

## [0.4.6](https://github.com/skynet-gh/skylobby/releases/tag/0.4.6)

- Add download sources for Total Atomization Prime releases and maps

## [0.4.5](https://github.com/skynet-gh/skylobby/releases/tag/0.4.5)

- Fix unready after game setting
- Stop sending !joinas spec for most servers

## [0.4.4](https://github.com/skynet-gh/skylobby/releases/tag/0.4.4)
...
## [0.4.3](https://github.com/skynet-gh/skylobby/releases/tag/0.4.3)

- Fix game specific settings backup and restore
- Fix replay chat spec player colors

## [0.4.2](https://github.com/skynet-gh/skylobby/releases/tag/0.4.2)

- Add option to auto backup/restore Spring settings by game type

## [0.4.1](https://github.com/skynet-gh/skylobby/releases/tag/0.4.1)
...
## [0.4.0](https://github.com/skynet-gh/skylobby/releases/tag/0.4.0)
...
## [0.3.66](https://github.com/skynet-gh/skylobby/releases/tag/0.3.66)
...
## [0.3.65](https://github.com/skynet-gh/skylobby/releases/tag/0.3.65)

- Add setting for git mod versioning

## [0.3.64](https://github.com/skynet-gh/skylobby/releases/tag/0.3.64)

- Fix register response message display
- Fix login error message for token auth

## [0.3.63](https://github.com/skynet-gh/skylobby/releases/tag/0.3.63)
...
## [0.3.62](https://github.com/skynet-gh/skylobby/releases/tag/0.3.62)

- Fix double click to open chat with user
- Fix auto scroll in popout chat window

## [0.3.61](https://github.com/skynet-gh/skylobby/releases/tag/0.3.61)
...
## [0.3.60](https://github.com/skynet-gh/skylobby/releases/tag/0.3.60)
...
## [0.3.59](https://github.com/skynet-gh/skylobby/releases/tag/0.3.59)

- Fix replay refresh for real

## [0.3.58](https://github.com/skynet-gh/skylobby/releases/tag/0.3.58)

- Fix replay refresh

## [0.3.57](https://github.com/skynet-gh/skylobby/releases/tag/0.3.57)

- Fix replay loading stuck on invalid files
- Fix map directories not being reloaded
- Fix duplicate maps not being removed

## [0.3.56](https://github.com/skynet-gh/skylobby/releases/tag/0.3.56)

- Display multiple download sources for maps
- Separate bot and human user counts

## [0.3.55](https://github.com/skynet-gh/skylobby/releases/tag/0.3.55)

- Fix agreement display and confirm

## [0.3.54](https://github.com/skynet-gh/skylobby/releases/tag/0.3.54)

- Update BAR server url
- Add BAR SSL server

## [0.3.53](https://github.com/skynet-gh/skylobby/releases/tag/0.3.53)
...
## [0.3.52](https://github.com/skynet-gh/skylobby/releases/tag/0.3.52)
...
## [0.3.51](https://github.com/skynet-gh/skylobby/releases/tag/0.3.51)

- Add shadow around player names
- Add option to interleave player ids in balance

## [0.3.50](https://github.com/skynet-gh/skylobby/releases/tag/0.3.50)

- Revert per-user install for Windows
- Add jvm flags for dpi scaling on Windows
- Fix factions for S44

## [0.3.49](https://github.com/skynet-gh/skylobby/releases/tag/0.3.49)

- Release to test auto updates

## [0.3.48](https://github.com/skynet-gh/skylobby/releases/tag/0.3.48)

- Fix mod update loop caused by re-scanning directories
- Fix auto update for installed exe

## [0.3.47](https://github.com/skynet-gh/skylobby/releases/tag/0.3.47)

- Set per-user install for Windows

## [0.3.46](https://github.com/skynet-gh/skylobby/releases/tag/0.3.46)

- Release to test auto updates

## [0.3.45](https://github.com/skynet-gh/skylobby/releases/tag/0.3.45)

- Add button to auto download updates and restart

## [0.3.44](https://github.com/skynet-gh/skylobby/releases/tag/0.3.44)
...
## [0.3.43](https://github.com/skynet-gh/skylobby/releases/tag/0.3.43)
...
## [0.3.42](https://github.com/skynet-gh/skylobby/releases/tag/0.3.42)
...
## [0.3.41](https://github.com/skynet-gh/skylobby/releases/tag/0.3.41)
...
## [0.3.40](https://github.com/skynet-gh/skylobby/releases/tag/0.3.40)

- Fix ingame status not set correctly
- Fix replay parsing sometimes causing memory issues

## [0.3.39](https://github.com/skynet-gh/skylobby/releases/tag/0.3.39)
...
## [0.3.38](https://github.com/skynet-gh/skylobby/releases/tag/0.3.38)

- Add chat log to replay details view

## [0.3.37](https://github.com/skynet-gh/skylobby/releases/tag/0.3.37)
...
## [0.3.36](https://github.com/skynet-gh/skylobby/releases/tag/0.3.36)
...
## [0.3.35](https://github.com/skynet-gh/skylobby/releases/tag/0.3.35)
...
## [0.3.34](https://github.com/skynet-gh/skylobby/releases/tag/0.3.34)

- Fix resource churn for replays and battle mods

## [0.3.33](https://github.com/skynet-gh/skylobby/releases/tag/0.3.33)
...
## [0.3.32](https://github.com/skynet-gh/skylobby/releases/tag/0.3.32)

- Fix modoptions missing
- Add map description

## [0.3.31](https://github.com/skynet-gh/skylobby/releases/tag/0.3.31)

- Fix occasional crash due to profiler concurrency
- Fix battle map suggest

## [0.3.30](https://github.com/skynet-gh/skylobby/releases/tag/0.3.30)
...
## [0.3.29](https://github.com/skynet-gh/skylobby/releases/tag/0.3.29)
...
## [0.3.28](https://github.com/skynet-gh/skylobby/releases/tag/0.3.28)
...
## [0.3.27](https://github.com/skynet-gh/skylobby/releases/tag/0.3.27)
...
## [0.3.26](https://github.com/skynet-gh/skylobby/releases/tag/0.3.26)
...
## [0.3.25](https://github.com/skynet-gh/skylobby/releases/tag/0.3.25)

- Add support for bridged chat
- Add custom CSS section to settings

## [0.3.24](https://github.com/skynet-gh/skylobby/releases/tag/0.3.24)

- Fix balance button and minimap type combo box
- Fix battles and users filter cli args
- Add springfiles download for maps

## [0.3.23](https://github.com/skynet-gh/skylobby/releases/tag/0.3.23)
...
## [0.3.22](https://github.com/skynet-gh/skylobby/releases/tag/0.3.22)

- Add server auto connect option
- Add `--chat-channel` cli arg

## [0.3.21](https://github.com/skynet-gh/skylobby/releases/tag/0.3.21)

- Fix `--skylobby-root` not coerced to file

## [0.3.20](https://github.com/skynet-gh/skylobby/releases/tag/0.3.20)
...
## [0.3.19](https://github.com/skynet-gh/skylobby/releases/tag/0.3.19)
...
## [0.3.18](https://github.com/skynet-gh/skylobby/releases/tag/0.3.18)

- Fix map details not loading automatically

## [0.3.17](https://github.com/skynet-gh/skylobby/releases/tag/0.3.17)
...
## [0.3.16](https://github.com/skynet-gh/skylobby/releases/tag/0.3.16)

- Add status icon for player sync
- Add chat commands for /msg and /ingame
- Add CLI flag `--server-url` to set selected server

## [0.3.15](https://github.com/skynet-gh/skylobby/releases/tag/0.3.15)
...
## [0.3.14](https://github.com/skynet-gh/skylobby/releases/tag/0.3.14)
...
## [0.3.13](https://github.com/skynet-gh/skylobby/releases/tag/0.3.13)
...
## [0.3.12](https://github.com/skynet-gh/skylobby/releases/tag/0.3.12)
...
## [0.3.11](https://github.com/skynet-gh/skylobby/releases/tag/0.3.11)

- Fix dependency issue with async library

## [0.3.10](https://github.com/skynet-gh/skylobby/releases/tag/0.3.10)

- Fix jar main class
- Fix battle map and mod details retry

## [0.3.9](https://github.com/skynet-gh/skylobby/releases/tag/0.3.9)
...
## [0.3.8](https://github.com/skynet-gh/skylobby/releases/tag/0.3.8)
...
## [0.3.7](https://github.com/skynet-gh/skylobby/releases/tag/0.3.7)

- Add support for TLS communication to the server

## [0.3.6](https://github.com/skynet-gh/skylobby/releases/tag/0.3.6)
...
## [0.3.5](https://github.com/skynet-gh/skylobby/releases/tag/0.3.5)

- Fix task workers not starting
- Fix resource details update spawning a thread
- Improve table column sizing

## [0.3.4](https://github.com/skynet-gh/skylobby/releases/tag/0.3.4)
...
## [0.3.3](https://github.com/skynet-gh/skylobby/releases/tag/0.3.3)

- Fix battle view render error
- Fix start positions in singleplayer

## [0.3.2](https://github.com/skynet-gh/skylobby/releases/tag/0.3.2)
...
## [0.3.1](https://github.com/skynet-gh/skylobby/releases/tag/0.3.1)

- Fix console not showing
- Add Hakora site as source for maps
- Stop building skyreplays release artifacts

## [0.3.0](https://github.com/skynet-gh/skylobby/releases/tag/0.3.0)
...
## [0.2.15](https://github.com/skynet-gh/skylobby/releases/tag/0.2.15)

- Add filtering by replay source

## [0.2.14](https://github.com/skynet-gh/skylobby/releases/tag/0.2.14)

- Improve feedback for downloading replays
- Add recursive replay sources

## [0.2.13](https://github.com/skynet-gh/skylobby/releases/tag/0.2.13)
...
## [0.2.12](https://github.com/skynet-gh/skylobby/releases/tag/0.2.12)

- Add color mode to chat channels
- Improve coloring in battles table, bold players
- Add skylobby update check

## [0.2.11](https://github.com/skynet-gh/skylobby/releases/tag/0.2.11)
...
## [0.2.10](https://github.com/skynet-gh/skylobby/releases/tag/0.2.10)
...
## [0.2.9](https://github.com/skynet-gh/skylobby/releases/tag/0.2.9)
...
## [0.2.8](https://github.com/skynet-gh/skylobby/releases/tag/0.2.8)

- Add back Linux jar building

## [0.2.7](https://github.com/skynet-gh/skylobby/releases/tag/0.2.7)
...
## [0.2.6](https://github.com/skynet-gh/skylobby/releases/tag/0.2.6)

- Initial public release

### [0.2.4](https://github.com/skynet-gh/skylobby/releases/tag/0.2.4) and [0.2.5](https://github.com/skynet-gh/skylobby/releases/tag/0.2.5)

- Fix Windows packaging

## [0.2.3](https://github.com/skynet-gh/skylobby/releases/tag/0.2.3)
...
## [0.2.2](https://github.com/skynet-gh/skylobby/releases/tag/0.2.2)

- Add ring handler and sound effect

## [0.2.1](https://github.com/skynet-gh/skylobby/releases/tag/0.2.1)

- Add setting to change Spring directory

## [0.2.0](https://github.com/skynet-gh/skylobby/releases/tag/0.2.0)
